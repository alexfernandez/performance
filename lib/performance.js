...
exports.runBenchmarks = function(seconds)
{
	...
	benchmark('Date.now()', function()
	{
		return Date.now();
	});
	benchmark('process.hrtime()', function()
	{
...
function benchmark(name, fn)
{
	...
	console.log('Function %s running for %s seconds: %s iterations per second, %s ns per iteration', name, seconds.toFixed(2), ips, ns);
}
